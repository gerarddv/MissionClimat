...
class Window(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        tables = [
            ...
            'code_region'),
             'query': 'SELECT id_travaux, cout_total_ht, cout_induit_ht, date_travaux, type_logement, annee_construction_logement, code_region FROM Travaux ORDER BY id_travaux'},
