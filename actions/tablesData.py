...
class Window(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        tables = [
            ...
            'id_travaux', 'cout_total_ht', 'cout_induit_ht', 'annee_travaux', 'type_logement', 'annee_construction_logement',
            'code_region'),
             'query': 'SELECT id_travaux, cout_total_ht, cout_induit_ht, annee_travaux, type_logement, annee_construction_logement, code_region FROM Travaux ORDER BY id_travaux'},
            {'name': 'RealiseDans', 'columns': ('code_departement', 'id_travaux'),
             'query': 'SELECT code_departement, id_travaux FROM Travaux JOIN Departements USING (code_region) ORDER BY code_departement'},
